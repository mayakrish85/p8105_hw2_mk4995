...
overall contains 14 columns and 849 rows. 653 rows contain data from the
`Mr. Trash Wheel` subset, 121 rows describe `Professor Trash Wheel`, and
264 rows describe `Gwynnda Trash Wheel.` Key variables include
...
is 488. A total of 1.812^{4} cigarette butts was collected by Gwynnda
...
name columns in `bakers_df`. I also converted thet `baker` column to
...
and `results_df`. Then I used a left join to put the datasets together
on “series”, “episode”, and “baker_first_name.”
...
based on that column? I think that logic may be correct, but I’m not
sure.
...
|-------:|--------:|:------------------|----------:|:-------------------------------------------|:---------------------------------|:-----------------------------------------------------------|:-----------------------------------|----------:|:-------|
|      5 |      10 | Nancy Birtwhistle |        60 | Retired Practice Manager                   | Barton-upon-Humber, Lincolnshire | Apple and Lemon KitesRaspberry and Almond Croissants       | Red Windmill                       |         1 | WINNER |
...
|      9 |      10 | Rahul Mandal      |        30 | Research scientist                         | Rotherham                        | NA                                                         | NA                                 |         2 | WINNER |
|     10 |      10 | David Atherton    |        36 | International health adviser               | Whitby                           | NA                                                         | NA                                 |         1 | WINNER |

The technical score of the winners of season 7, 8, and 9 is 2 (not the
best overall score), so it’s surprising that they won. The other winners
were as expected.
