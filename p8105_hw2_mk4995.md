...
The resulting dataset, `final_tidy_df` contains the three merged
datasets, which I joined on “series” and “baker_first_name.” Then, I
cleaned the dataset by putting the first and last name columns back
together. Lastly, I relocated the columns “series” and “episodes” to the
head of the dataset and arranged the dataset in ascending order of
series and episodes.
...
way to further reorganize and clean the data?
